...
class Character:
    ...
    def attack(self, target: "Character"):
        """Perform an attack against a target character.

        NOTE: This method is deprecated. All combat actions now go through the API.
        """
        raise NotImplementedError("Combat actions are handled via the API. Use CombatClient instead.")
...
class PlayerCharacter(Character):
    ...
    def cast_spell(self, spell_name: str, target: Optional["Character"] = None) -> str:
        """Cast a spell using the player's class rules.

        NOTE: This method is deprecated. All combat actions now go through the API.
        """
        raise NotImplementedError("Combat actions are handled via the API. Use CombatClient instead.")

    def attempt_flee(self, enemies: List["Character"]):
        """Attempt to flee combat using dexterity checks.
